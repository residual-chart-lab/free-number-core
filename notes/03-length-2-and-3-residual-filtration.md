...
$$
V=\mathrm{Im}\,\mathbb{H}
=\mathrm{span}_{\mathbb{R}}\{i,j,k\}.
$$
...
$$
\mathcal{R}_3^{(1)},\mathcal{R}_3^{(2)}:
V^{\otimes3}\to\mathrm{Hom}(V,\mathbb{H}).
$$
