...
exceptional \(144+4\) split. Note 24 then exhausts the admissible
transported-anchor histories and proves that their same-word transitions
are generated by three pair-local copies of \(\theta,\theta^{-1}\). What
remains is to construct transports between adjacent spacing words and
compose independently defined paths around genuine closed loops.
